...
import Anurag from '../assets/AnuragBackground.jpg'
...
const DisplayPlaylist = () => {
  ...
  useEffect(() => {
    const fetchPlaylist = async () => {
      try {
        const res = await axios.post('http://localhost:4000/api/playlist/get', 
        {},
        {
          headers:{
  ...
  return (
    ...
    <Navbar/>
      ...
      <img className='w-48 rounded' src={Anurag} alt="" />
